...
sed -i '' 's/CN CN CE ST.*/CN CN CE ST 3 9.0972   4.8960 -18.5431  -0.1332  -9.4417   9.3218 /g' OBT.ff/ffOBT.itp
...
do
	...
	2 1 35 36 1 $i 0 1500
	34 33 37 46 1 0 0 200
	41 40 44 50 1 0 0 200
	18 17 23 26 1 60 0 200
	5 7 27 30 1 60 0 200
	EOF
	) > topol.top
