...
sed -i '' 's/CN CN CE ST.*/CN CN CE ST 3  9.488   2.395 -32.492  -2.560 -22.409  -1.029 /g' OBT.ff/ffOBT.itp
...
do
	...
	2 1 35 36 1 $i 0 400
	34 33 37 44 1 0 0 50
	40 39 43 48 1 0 0 50
	18 17 23 26 1 60 0 50
	5 7 27 30 1 60 0 50
	EOF
	) > topol.top
