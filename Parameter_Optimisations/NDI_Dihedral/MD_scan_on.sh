...
sed -i '' 's/CN CN CE ST.*/CN CN CE ST 3  7.379  -3.664 -24.769   2.383   4.335  -5.369 /g' OBT.ff/ffOBT.itp
...
do
	...
	2 1 35 36 1 $i 0 2000
	34 33 37 44 1 0 0 100
	40 39 43 48 1 0 0 100
	18 17 23 26 1 60 0 100
	5 7 27 30 1 60 0 100
	EOF
	) > topol.top
